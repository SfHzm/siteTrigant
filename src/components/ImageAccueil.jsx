export default function ImageAccueil({ src, alt, className, h, p = "" }) {
  return (
    <div className={`relative w-full h-60 md:h-fit ${className}`}>
      <img
        src={src}
        alt={alt}
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center text-white-text gap-5 pt-3.5">
        <p className="font-artemisia text-[1.4rem] md:text-4xl lg:text-5xl text-center leading-relaxed" style={{whiteSpace: "pre"}}>{h}</p>
