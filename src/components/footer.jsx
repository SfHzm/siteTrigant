    ...
    <footer className="footer w-full h-fit mt-[var(--space-small)]  md:mt-[var(--space-big)] text-white-text gap-0 lg:mt-0">
      <div className="w-[100vw] flex flex-col justify-center items-center bg-accent-gold pt-5 md:py-5">
        ...
        <div className="flex gap-5">
          ...
          <p>
            <a
              href="https://www.instagram.com/chateau.trigant/?hl=fr"
              target="_blank"
              className="flex svgHover md:justify-center gap-2 mt-4 px-5 py-2 font-bold text-white bg-accent-gold border-2 border-white rounded-lg lg:hover:bg-white lg:hover:text-accent-gold transition-all duration-300 transform hover:-translate-y-1 shadow-md mx-auto md:mx-0"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
                className="w-[20px] fill-bg transition-colors duration-300"
              >
