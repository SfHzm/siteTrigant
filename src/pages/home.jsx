      ...
      <div className="w-full flex justify-center items-center mt-[var(--space-big)]">
        <div className="flex flex-col items-center w-[90vw] py-[2.5vw] h-fit bg-accent-gold">
          ...
          >
            ...
            <Link
              to="/mariage"
              className="btn btn-xs sm:btn-sm md:btn-md lg:btn-lg xl:btn-xl border-1 rounded-xs border-accent-content text-accent-content font-normal font-abhaya text-sm float-right mt-5 p-4"
            >
              En savoir +
            </Link>
          </div>
